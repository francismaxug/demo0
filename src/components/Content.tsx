...
const Content = () => {
  return (
    <>
      <div className=" w-full h-full md:h-full hidden md:block">
        <div className="bg-[url('/sample.png')] full-screen-bg  w-full h-auto md:h-full md:bg-cover bg-contain bg-no-repeat md:bg-top   md:rounded-xl ">
          <div className=" flex flex-col">
              ...
              <div className=" flex flex-col  md:gap-y-28 xl:gap-y-16   border-[7px] border-b-0 border-white place-content-start w-full ">
                ...
                <div className="flex flex-col gap-y-20 px-4 py-4  border-white border-b-[7px] overflow-hidden rounded-xl pt-6 2xl:pt-7">
                  ...
                  <div className=" text-gray-300 drop-shadow-2xl shadow-inner lg:flex  gap-x-2 items-center justify-between space-y-3 lg:space-y-0">
                    <p className=" text-[0.7rem] w-[22rem]">
                      Share your ideas and tell us how you can contribute to
                      this cause. Together, we can make an impact.
                    </p>
            ...
            <div className=" border-l-[7px] border-white ">
              <div className=" hidden md:block py-4 md:px-[0rem] xl:px-[0rem] md:border-[7px]  border-white w-full rounded-lg">
                <div className=" grid md:grid-cols-3 px-4 w-full gap-x-6 rounded-lg">
                  ...
                  <div className=" hidden   bg-white rounded-lg  md:flex md:flex-col  p-3">
                    ...
                    <div className=" flex md:flex-col lg:flex-row gap-x-3 items-center justify-between h-full">
                      ...
                      <Image
                        ...
                        height={500}
                        alt="image"
                        className=" lg:h-[5rem] lg:w-[5rem] xl:h-[6.5rem] xl:w-[6.5rem] md:w-[4rem] md:h-[4rem]"
                      />
                    </div>
                  </div>
                </div>
        ...
        <div className="absolute inset-0 flex flex-col justify-between py-5 px-4">
          <div className="space-y-3">
            <p className="text-white text-3xl font-semibold">
              Understanding the Global Impact Trends of COVID-19
            </p>
            <p className="text-white text-[0.85rem]">
              Share your ideas and tell us how you can contribute to this cause.
      ...
      <div className=" px-4">
        <div className="bg-[url('/pic11.png')] md:hidden  w-full  bg-cover bg-center  rounded-md border-b-[8px] border-white  mt-7">
          <div className=" bg-black/60 w-full  text-white py-3 mb-[0.01rem] px-3 overflow-hidden rounded-md">
      ...
      <div className=" md:hidden  w-full  bg-white rounded-lg  p-4 text-center space-y-4 ">
      ...
      <div className=" bg-black md:bg-white text-center md:text-black text-white text-[0.65rem]">
        <p>All rights reserved. Team BroCode 2024</p>
      </div>
    </>
  )
}
